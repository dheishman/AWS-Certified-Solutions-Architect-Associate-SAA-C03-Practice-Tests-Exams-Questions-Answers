...
<details><summary>Answer</summary>	<li>2: Object versioning and Multi-factor authentication.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: The user account has reached the maximum EC2 instance limit.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>5: Amazon S3 to host videos with Lifecycle Management to archive original files to Glacier after a few days. CloudFront to serve HLStranscoded videos from S3.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Implement IDS/IPS agents on each Instance running in VPC.
</li>	<li>4: Implement a reverse proxy layer in front of web servers and configure IDS/ IPS agents on each reverse proxy server.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A successful response to a PUT request only occurs when a complete object is saved.
</li>	<li>5: S3 provides eventual consistency for overwrite PUTS and DELETE.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: By using an Amazon Route 53 Alias record.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: If you have batch-oriented workloads.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Use reduced redundancy storage (RRS) for PDF and .csv data in Amazon S3. Add Spot Instances to Amazon EMR jobs. Use Reserved Instances for Amazon Redshift.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: No, Docker is the only container platform supported by EC2 Container Service presently.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Amazon S3 as the origin server and Amazon CloudFront for caching.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: AWS Storage Gateway.
</li>	<li>4: Amazon Glacier.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: reserved for the root device.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: By using the service specific console or APICLI commands.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Non-critical or reproducible data.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: A fast, highly scalable managed NoSQL database service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Force IAM users to contact an account administrator when the user has entered his password incorrectly.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: An application container on top of Amazon Web Services.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The user can zoom a particular period by selecting that period with the mouse and then releasing the mouse.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Replace RDS with Redshift for the batch analysis and SNS to notify the on-premises system to update the dashboard.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: A route should be created as 0.0.0.0/0 and your internet gateway as target.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Attach one more volume with RAID 1 configuration.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Set an S3 ACL on the bucket or the object.
</li>	<li>3: Set an S3 bucket policy.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Route 53 natively supports ELB with an internal health check. Turn 'Evaluate target health' on and 'Associate with Health Check' off and R53 will use the ELB's internal health check.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Prevents /dev/sdc from attaching to the instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: You can't terminate, stop, or delete a resource based solely on its tags.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Yes for all instance types.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: The outbound network ACL needs to be modified to allow outbound traffic.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Configure ELB with two c3 2xiarge Instances and use on-demand Autoscaling group for up to two additional c3.2xlarge instances Shut on mi .large instances.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Create and mount a new, encrypted Amazon EBS volume. Move the data to the new volume. Delete the old Amazon EBS volume.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Configure the IP range of the US West region instance as the ingress security rule of RDS.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Connects an on-premises software appliance with cloud-based storage to provide seamless and secure integration between your on-premises IT environment and AWS's storage infrastructure.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Because most reachability issues are resolved by automated processes in less than 20 minutes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You can transfer existing domains into Amazon Route 53's management.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Data is automatically deleted.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: ELB uses a four-tier, key-based architecture for encryption.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Automatically assign public IP addresses to the application instances in the Auto Scaling group and run a script on boot that adds each instances public IP address to the payment validation whitelist AP.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Every Amazon SES sender has a unique set of sending limits.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Deploy ElasticCache in-memory cache running in each Availability Zone.
</li>	<li>4: Add an RDS MySQL read replica in each Availability Zone.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A collection of related Workflows.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Allow no inbound traffic and allow all outbound traffic.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: You need to create storage in EBS first.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Enable Multi-Factor Authentication for your AWS root account.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Use Amazon Simple Workflow (SWF) to manages assessments, movement of data & meta-data Use an auto-scaling group of G2 instances in a placement group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Place all your web servers behind EL8 Configure a Route 53 CNAME to point to the ELB DNS name.
</li>	<li>4: Assign EIPs to all web servers. Configure a Route 53 record set with all EIPs. With health checks and DNS failover.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Set permissions on the object to public read during upload.
</li>	<li>3: Configure the bucket policy to set all objects to public read.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: All items listed here are important when thinking about disaster recovery.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Setup a DynamoDB table with an item for each user having the necessary attributes to hold the user preferences. The mobile application will query the user preferences directly from the DynamoDB table. Utilize ST.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You did not setup an HTTP health check tor one or more of the weighted resource record sets associated with me disabled web servers.
</li>	<li>5: You did not set 'Evaluate Target Health' to 'Yes' on the latency alias resource record set associated with example com in the region where you disabled the servers.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Add a WAF tier by creating a new ELB and an AutoScaling group of EC2 Instances running a host based WAF They would redirect Route 53 to resolve to the new WAF tier ELB The WAF tier wouldthier pass the traffic to the current web tier The web tier Security Groups would be updated to only allow traffic from the WAF tier Security Group
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Configure a single routing Table with a default route via the Internet gateway Propagate a default route via BGP on the AWS Direct Connect customer router. Associate the routing table with all VPCsubnets.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Create a virtual private gateway with multiple customer gateways, each with unique Border Gateway Protocol (BGP) Autonomous System Numbers (ASNs).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Supported on all Amazon EBS volume types.
</li>	<li>2: Snapshots are automatically encrypted.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Enable AWS CloudTrail for the load balancer.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Relational Database Service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: All of the items listed on this page.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Dynamic DB is designed to scale without limits, but if you go beyond 10,000 you have to contact AWS first.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: A firewall for inbound traffic, built-in around every Amazon EC2 instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: DB security groups, VPC security groups, and EC2 security groups.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: You can improve load and response times to user actions and queries and also reduce the cost associated with scaling web applications.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Use AWS Consolidated Billing to link the divisions' accounts to a parent corporate account.
</li>	<li>5: Write all child AWS CloudTrail and Amazon CloudWatch logs to each child account's Amazon S3 'Log' bucket.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Create a set of Access Keys for the user.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: You can use the BitTorrent protocol but only for objects that are less than 5 GB in size.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Auto Scaling, Amazon CloudWatch and Elastic Load Balancing.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: It starts when Amazon EC2 initiates the boot sequence of an AMI instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Make your own DB system which stores the S3 metadata for the search functionality.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: The application authenticates against LDAP and retrieves the name of an IAM role associated with the user. The application then ca lls the IAM Security Token Service to assume that IAM role The application can use the temporary credentials to access the appropriate S3 bucket.
</li>	<li>3: Develop an identity broker that authenticates against LDAP and then calls IAM Security To ken Service to get IAM federated user credentials The application calls the identity broker to get IAMfederated user credentials with access to the appropriate S3 bucket.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Yes, but each Reserved Instance is associated with a specific Region that cannot be changed.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Different instances running on the same physical machine are isolated from each other via the Xen hypervisor.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The instance does not have a public IP address.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: CloudFormation is much more powerful than Elastic Beanstalk, because you can actually design and script custom resources.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Use two SQS queues, one for high priority messages, the other for default priority. Transformation instances first poll the high priority queue; if there is no message, they poll the default priority queue.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Yes, AWS CloudFormation supports Amazon EC2 tagging.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create an IAM role for cross-account access allows the SaaS provider's account to assume the role and assign it a policy that allows only the actions required by the SaaS application.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Data persists in the instance store.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Use an Amazon CloudFront distribution for both static and dynamic content.
</li>	<li>4: Use an Elastic Load Balancer with auto scaling groups at the web. App and Amazon Relational Database Service (RDS) tiers.
</li>	<li>5: Add alert Amazon CloudWatch to look for high Network in and CPU utilization.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: specify the URL of the load balancer for the domain name of your origin server.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: The number of ENIs you can attach varies by instance type.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Public (IPV4) internet addresses are a scarce resource.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Use Amazon S3 multipart upload.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Amazon EBS volumes or Amazon S3.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use RDS Multi-AZ with two tables, one for 'Active calls' and one for 'Terminated calls'. in this way the 'Active calls' table is always small and effective to access.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: A private IP address and a public IP address.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Enable AWS CloudTrail to audit all Amazon S3 bucket access.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Configure an IAM Role that grants access to an Amazon S3 object containing a signed certificate and configure me Auto Scaling group to launch instances with this role Have the instances bootstrap get the certificate from Amazon S3 upon first boot.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use Amazon S3 server-side encryption with AWS Key Management Service managed keys.
</li>	<li>2: Use Amazon S3 server-side encryption with customer-provided keys.
</li>	<li>5: Encrypt the data on the client-side before ingesting to Amazon S3 using their own master key.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: your EC2 instance is in a running state.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Use the IAM role and assign it to the instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create IAM users in the Master account Create cross-account roles in the Dev and Test accounts that have full Admin permissions and grant the Master.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Deploy a Windows Bastion host with an Elastic IP address in the private subnet, and restrict RDP access to the bastion from only the corporate public IP addresses.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Use CloudFront and an Elastic Load Balancer in front of an auto-scaled set of web servers, the web servers will first call the Login. With Amazon service to authenticate the user, the web servers win process the users vote and store the result into an SQS queue using IAM Roles for EC2 Instances to gain permissions to the SQS queue. A set of application servers will then retrieve the items from the queue and store the result into a DynamoDB table.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Record the user's Information in Amazon RDS and create a role in IAM with appropriate permissions. When the user uses their mobile app create temporary credentials using the AWS Security Token Service 'Assume Role' function Store these credentials in the mobile app's memory and use them to access Amazon S3 Generate new credentials the next time the user runs the mobile app.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Serve user content from S3. CloudFront and use Route 53 latency-based routing between ELBs in each region Retrieve user preferences from a local DynamoDB table in each region and leverage SQS to capture changes to user preferences with 505 workers for propagating updates to each table.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Amazon EBS-backed instances can be stopped and restarted.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: All items listed here are important when thinking about disaster recovery.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: After you launch an instance in EC2-Classic, you can't change its security groups.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Immediately to all instances in the security group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: An edge location is the location of the data center used for Amazon CloudFront.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Multiple facilities in eu-west-1.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Verify that the private key file corresponds to the Amazon EC2 key pair assigned at launch.
</li>	<li>3: Verify that you are connecting with the appropriate user name for your AMI.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Send an SNS notification, if configured to do so.
</li>	<li>4: Terminate an instance in the AZ which currently has 2 running EC2 instances.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Yes, they are allowed but only with approval.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Create an Origin Access Identity (OAI) for CloudFront and grant access to the objects in your S3 bucket to that OA.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Use smaller instances that have higher aggregate 1/0 performance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: An Alias record can map one DNS name to another Amazon Route 53 DNS name.
</li>	<li>3: An Amazon Route 53 CNAME record can point to any DNS record hosted anywhere.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Basic, Developer, Business, Enterprise.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A scalable architecture won't be cost effective as it grows.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon CloudWatch.
</li>	<li>5: Amazon Simple Notification Service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: The ELB supports either IPV4 or IPV6 but not both.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: A graphical Java tool distributed without cost by Oracle.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: security groups and network ACLs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: No because you can't use IAM to control access to CloudWatch data for specific resources.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: AWS Identity and Access Management (IAM).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: The EBS-Optimized throughput limits the total IOPS that can be utilized; use an EBS Optimized instance that provides larger throughput. Mo
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Configure the security group of EC2, which allows access to the ELB source security group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Before you can delete an SSL certificate, you need to either rotate SSL certificates or revert from using a custom SSL certificate to using the default CloudFront certificate.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: A security group that has port 22 (for SSH) or port 3389 (for RDP) open to your network.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Configure servers running in the VPC using the host-based 'route' commands to send all traffic through the platform to a scalable virtualized IDS/IP.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Remove public read access and use signed URLs with expiry dates.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Frequent snapshots provide a higher level of data durability and they will not degrade the performance of your application while the snapshot is in progress.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: based on Availability Zone.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Because they provide unrestricted access to your AWS resources.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: to read or modify the table directly, without a middle-tier service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Al low no inbound traffic and Al low all outbound traffic.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You are billed for the virtual tape data you store in Amazon Glacier and billed for the portion of virtual tape capacity that you use, not for the size of the virtual tape.
</li></ul>
</details>
...
- [ ] Security Group Inbound Rule: Protocol – TCP.
...
<details>
	<summary>Answer</summary>
	<li>1: Security Group Inbound Rule: Protocol – TCP.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>5: Use an encrypted file system on top of the EBS volume.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon Elastic MapReduce.
</li>	<li>5: AWS Elastic Beanstalk.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use the EC2 VM Import Connector for vCenter to import the VM into EC2.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Amazon Glacier automatically encrypts the data using AES-256, the same as Amazon S3.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Yes for all RDS instances.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Every packet sent in the AWS network uses Internet Protocol Security (IPsec).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Yes, you should turn on the CloudTrail in the AWS console.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Performance, cost optimization, security, and fault tolerance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create a CloudFront distribution with S3 access restricted only to the CloudFront identity and partition the blog entry's location in S3 according to the month it was uploaded to be used withCloudFront behaviors.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Command-line tools to the Amazon EC2 web service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Backup RDS using automated daily DB backups Backup the EC2 instances using AMIs and supplement with file-level backup to S3 using traditional enterprise backup software to provide file level restore.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Metrics for CloudWatch are available only when you choose the US East (Virginia).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The load balancer was not configured to use a public subnet with an Internet gateway configured.
</li>	<li>3: The security groups or network ACLs are not property configured for web traffic.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: BYOL and License Included.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Security Group and ACL (Access Control List) settings.
</li>	<li>3: Patch management on the EC2 instance's operating system.
</li>	<li>4: Life-cycle management of IAM credentials.
</li>	<li>6: Encryption of EBS (Elastic Block Storage) volumes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Deploy 3 EC2 instances in one Availability Zone and 3 in another Availability Zone and use Amazon Elastic Load Balancer.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Take hourly DB backups to S3, with transaction logs stored in S3 every 5 minutes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: You can use multiple layers of security, including security groups and network access control lists (ACL).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: There is no charge for using the public data sets.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon Route 53 can help detect an outage of your website and redirect your end users to alternate locations.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon Simple Queue Service (SOS) for capturing the writes and draining the queue to write to the database.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: File a change request to implement Proxy Protocol support in the application. Use an ELB with a TCP Listener and Proxy Protocol enabled to distribute load on two application servers in different AZs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Leverage resource based tagging along with an IAM user, which can prevent specific users from terminating production EC2 resources.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Updates to your DB Instance are synchronously replicated across Availability Zones to the standby in order to keep both in sync and protect your latest database updates against DB Instance failure.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Offload traffic from on-premises environment: Setup a CloudFront distribution, and configure CloudFront to cache objects from a custom origin. Choose to customize your object cache behavior, and select a TIL that objects should exist in cache.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Paying account and Linked account.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: EBS with Provisioned IOPS (PIOPS) to store 1/0 files SOS to distribute elaboration commands to a group of hosts working in parallel Auto Scaling to dynamically size the group ot hosts depending on the length of the SQS queue.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: <http://169.254.169.254/latest/>.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Use SNS to pass job messages use Cloud Watch alarms to terminate spot worker instances when they become idle. Once data is processed, change the storage class of the S3 object to Glacier.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: All instances must be in the same AZ.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Rollback all the changes and terminate all the created services.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>5: Instantiate an i2.8xlarge instance in us-east-1a. Create a RAID 0 volume using the four 800GB SSD ephemeral disks provided with the instance. Configure synchronous, block-level replication to an identically configured instance in us-east-1b.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: AWS Directory Service AD Connector.
</li>	<li>4: AWS identity and Access Management roles.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Use SWF with an Auto Scaling group of activity workers and a decider instance in another Auto Scaling group with min/max=l use SES to send emails to customers.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: In the security group, open port 22 for IP 10.20.30.40/32.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A low-cost storage service that provides secure and durable storage for data archiving and backup.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Create a CloudFront distribution, and configure the Amazon EC2 instance as the origin.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Auto Scaling launch configuration.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Auto Scaling automatically creates a launch configuration directly from an EC2 instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You can have up to 3 VPC peering connections between the same two VPCs at the same time.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Attaching another network interface to an instance is a valid method to increase or double the network bandwidth to or from the dual-homed instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: All of the things listed here.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: For each regional deployment, use RDS MySQL with a master in the region and a read replica in the HQ region.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Amazon Glacier multipart upload.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: The EC2 instance follows the rules of both the subnets.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: The ELB has scaled-up, adding more instances to handle the traffic spike, reducing the number of available private IP addresses for new instance launches.
</li>	<li>5: AWS reserves the first four and the last IP address in each subnet's CIDR block so you do not have enough addresses left to launch all of the new EC2 instances.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: You change storage type from standard to PIOPS, and Apply Immediately is set to true.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: An AWS Direct Connect link between the VPC and the network housing the internal services.
</li>	<li>4: An IP address space that does not conflict with the one on-premises.
</li>	<li>6: A VM Import of the current virtual machine.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Assign the existing IAM role to the Amazon EC2 instances in the new region.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Assign a group of sequential Elastic IP address to the instances.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Use S3 with standard redundancy to store and serve the scanned files, use Cloud5earch for query processing, and use Elastic Beanstalk to host the website across multiple Availability Zones.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: No, they cannot be made public.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: The VPCs have non-overlapping Cl DR blocks in the same account. The route tables contain local routes for all VPCs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: AWS Identity and Access Management.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: The user should attach an IAM role with DynamoDB access to the EC2 instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The settings will be effective immediately for all the instances in the security group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Yes, if configured with the Auto Scaling group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Oracle Enterprise Edition.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create an Identity and Access Management Role that has the required permissions to read and write from the required DynamoDB table and reference the Role in the instance profile property of the application instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Auto Scaling must launch a new instance to replace it.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: All data stored on Glacier is protected with AES-256 serverside encryption.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Establish a hardware VPN over the internet between VPC-1 and the on-premises network.
</li>	<li>5: Establish a new AWS Direct Connect connection and private virtual interface in the same AWS region as VPC-1.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Add an Amazon ElastiCache caching layer to your application for storing sessions and frequent DB queries.
</li>	<li>3: Configure Amazon CloudFront dynamic content support to enable caching of re-usable content from your site.
</li>	<li>4: Switch Amazon RDS database to the high memory extra large Instance type.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Use Amazon Route 53, and apply a weighted routing policy to distribute traffic across both regions.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Gateway-cached lets you store your data in Amazon Simple Storage Service (Amazon S3) and retain a copy of frequently accessed data subsets locally. Gateway-stored enables you to configure your on-premises gateway to store all your data locally and then asynchronously back up point-in-time snapshots of this data to Amazon S3.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Control what IP addresses or EC2 instances can connect to your databases on a DB instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: All answers listed are a reasonable response to his question.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: You must have IP connectivity to the instance from the network you are connecting from.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Yes, both increment and decrement operations.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Amazon EC2 placement groups.
</li>	<li>2: Enhanced networking.
</li>	<li>4: Amazon HVM AMI.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Store a snapshot of the volume.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Launch a new AWS Storage Gateway instance AMI in Amazon EC2, and restore from a gateway snapshot.
</li>	<li>5: Create an Amazon EBS volume from a gateway snapshot, and mount it to an Amazon EC2 instance.
</li>	<li>6: Launch an AWS Storage Gateway virtual iSCSI device at the branch office, and restore from a gateway snapshot.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Send all the log events to Amazon Kinesis develop a client process to apply heuristics on the logs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon Simple Storage Service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Configure your DirectConnect router, update your VPC route tables to point to the DirectConnect connection, configure your VPN connection with a higher BGP pointy. And verify network traffic is leveraging the DirectConnect connection.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: All of the items listed will track the performance and health of a database.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Enable CloudFront to deliver access logs to S3 and use them as input of the Elastic MapReduce job.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use an Amazon Elastic MapReduce (EMR) S3DistCp as a synchronization mechanism between the on-premises database and a Hadoop cluster on AWS.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: With AWS CloudTrail you can get a history of AWS API calls and related events for your account.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Add a bucket policy to the bucket.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Configure ELB with TCP listeners on TCP/4d3. And place the Web servers behind it.
</li>	<li>2: Configure your Web servers with EIPS Place the Web servers in a Route 53 Record Set and configure health checks against all Web servers.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Storing JSON documents.
</li>	<li>5: Running relational joins and complex updates.
</li>	<li>6: Storing large amounts of infrequently accessed data.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: All of the answers listed here.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use the AWS Web identity federation for mobile applications, and use it to generate temporary security credentials for each user.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: AWS Identity & Access Management.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: A placement group can span multiple Availability Zones.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Less redundancy for a lower cost.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Instances that you launch into a default subnet receive both a public IP address and a private IP address.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Managing a multi-step and multi-decision checkout process of an e-commerce website.
</li>	<li>3: Orchestrating the execution of distributed and auditable business processes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: General purpose T2.
</li>	<li>4: Compute-optimized C3.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Stateless instances for the web and application tier synchronized using Elasticache Memcached in an autoscaimg group monitored with CloudWatch. And RDSwith read replicas.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Key pairs are used only for Amazon EC2 and Amazon CloudFront.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A managed In-memory cache service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: User-based and Resource-based.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Utilize Amazon Kinesis to collect the inbound sensor data, analyze the data with Kinesis clients and save the results to a Red shift cluster using EMR.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Maintain two snapshots: the original snapshot and the latest incremental snapshot.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: It allows to integrate on-premises IT environments with Cloud Storage.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Replace the RDS instance with a 6 node Redshift cluster with 96TB of storage.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Credential reports are downloaded XML files.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: May be performed by AWS, and is periodically performed by AWS.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Instances, Amazon Machine Images (AMIs), Key Pairs, Amazon EBS Volumes, Firewall, Elastic IP address, Tags, and Virtual Private Clouds (VPCs).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: It is possible to implement your own health check system and then send the instance's health information directly from your system to Cloud Watch.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Create a bastion and NAT instance in subnet-258bc44d, and add a route from rtb- 238bc44b to the NAT instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Launch a RDS Read Replica connected to your Multi-AZ master database and generate reports by querying the Read Replica.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A scalable Domain Name System.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Configure the Cloud Watch alarm on the instance that should perform the termination action once the instance is idle.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: A single Amazon S3 bucket.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Use your on-premises SAML2.0-compliam identity provider (IOP) to retrieve temporary security credentials to enable NOC members to sign in to the AWS Management Console.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: An Instance store Hardware Virtual Machine AMI.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: The IP addresses belong to EC2 Classic; so they cannot be assigned to VPC.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Disk usage activity of an EC2 instance.
</li></ul>
</details>
...
- [ ] Use AWS data Pipeline to schedule a DynamoDB cross region copy once a day. create a Last updated' attribute in your DynamoDB table that would represent the timestamp of the last update and use it as a filter.
...
<details>
	<summary>Answer</summary>
	<li>1: Use AWS data Pipeline to schedule a DynamoDB cross region copy once a day. create a Last updated' attribute in your DynamoDB table that would represent the timestamp of the last update and use it as a filter.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Create a new CloudTrail trail with one new S3 bucket to store the logs and with the global services option selected Use IAM roles S3 bucket policies and Multi Factor Authentication (MFA) Delete on the S3 bucket that stores your logs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: You can modify the rules for a security group at any time.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Is stateful: Return traffic is automatically allowed, regardless of any rules.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: AWS will throw an error saying that the AMI is deregistered.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create a snapshot of the volume, and create a new volume from the snapshot in the other AZ.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Amazon EC2 instances in a replication configuration utilizing two different Availability Zones.
</li></ul>
</details>
...
- [ ] Yes, you can enable encryption when you create a new EBS volume using the AWS Management Console, API, or CLI.
...
<details>
	<summary>Answer</summary>
	<li>1: Yes, you can enable encryption when you create a new EBS volume using the AWS Management Console, API, or CLI.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: latency-based routing; weighted resource record sets.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon Elastic Compute Cloud (EC2).
</li>	<li>3: Amazon Elastic Load Balancing.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create a CNAME record aliased to the load balancer DNS name.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Elastic Load Balancing request routing.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: M3 instances are configured with more swap memory than M1 instances.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Yes, but only for certain situations.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: CloudTrail is enabled on a per-region basis.
</li>	<li>4: CloudTrail is enabled on a per-service basis.
</li>	<li>5: Logs can be delivered to a single Amazon S3 bucket for aggregation.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Adjust the instance's Security Group to permit ingress traffic over port 22 from your IP.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Hadoop is an open source Java software framework.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Enable route propagation to the virtual pinnate gateway (VGW).
</li>	<li>5: Modify the Instances VPC subnet route table by adding a route back to the customer's on-premises environment.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You can choose to use any of the three kinds of NAT devices offered by AWS for special purposes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: In the EC2-VPC platform, the Elastic IP Address (EIP) does not remain associated with the instance when you stop it.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Creates a new security group for use with your account.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Route 53 supports Domain Name System Security Extensions (DNSSEC).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: It can be migrated across Availability Zones.
</li>	<li>4: It is specific to an instance Type.
</li>	<li>5: It can be used to lower Total Cost of Ownership (TCO) of a system.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Instance with the nearest billing hour in US-East-1A.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Assign an Elastic IP address to the fourth instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: It provides an encrypted virtual disk in the Cloud.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: A feature that enables EC2 instances to interact with each other via high bandwidth, low latency connections.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Private address IP 10.201.31.6 is currently assigned to another interface.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: It increases the need to forecast traffic by providing dynamic IP addresses for static cloud computing.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Configure the security group of the US East region to allow traffic from the US West region's instance and configure the RDS security group's ingress rule for the US East EC2 group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: 1/0 operations to the database are suspended for a few minutes while the backup is in progress.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Data is unavailable until the instance is restarted.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Amazon SQS is a distributed queuing system that is optimized for horizontal scalability, not for single-threaded sending or receiving speeds.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: 1/0 operations to the database are suspended for a few minutes while the backup is in progress.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Disabling the Source/Destination Check attribute on the NAT instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Use temporary security credentials that assume a role providing access to the Score Data DynamoDB table and the Game State S3 bucket using web identity federation.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Yes, you should deploy two Memcached ElastiCache Clusters in different AZs because the RDS instance will not be able to handle the load if the cache node fails.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Elastic Load Balancing, Amazon EC2, and Auto Scaling.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Data encryption across the Internet.
</li>	<li>4: Protection of data in transit over the Internet.
</li>	<li>5: Peer identity authentication between VPN gateway and customer gateway.
</li>	<li>6: Data integrity protection across the Internet.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: The total volume of data and number of archives you can store are unlimited.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Create a new Amazon DynamoDB able each day and drop the one for the previous day after its data is on Amazon S3.
</li>	<li>3: Introduce an Amazon SQS queue to buffer writes to the Amazon DynamoDB table and reduce provisioned write throughput.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: You are running the proxy on an undersized EC2 instance type so network throughput is not sufficient for all instances to download their updates in time.
</li>	<li>2: You are running the proxy on a sufficiently-sized EC2 instance in a private subnet and its network throughput is being throttled by a NAT running on an undersized EC2 instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You are charged for the stack resources for the time they were operating (even if you deleted the stack right away).
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: A template to map network resources for Amazon Web Services.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: An IAM user assigned a bucket policy to an Amazon S3 bucket and didn't specify the root user as a principal
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Cannot be used until the snapshot completes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: We charge less where our costs are less.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Create an AMI of the instance and copy the AMI to the EU region. Then launch the instance from the EU AMI.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Three: MySQL, Oracle and Microsoft SQL Server.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Yes, using the AWS multi-factor token devices to authenticate users on the AWS platform.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: reserved for the root device.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Yes, it supports Name Server records.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: The ELB stops sending traffic to the instance that failed its health check.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: The US-East-1a region of George and Ray can be different Availability Zones.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: AWS uses the techniques detailed in DoD 5220.22-M to destroy data as part of the decommissioning process.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Each subnet maps to a single Availability Zone.
</li>	<li>5: Instances in a private subnet can communicate with the Internet only if they have an Elastic IP.
</li></ul>
</details>
...
- [ ] Configure a web proxy server in your VPC and enforce URL-based ru les for outbound access Remove default routes.
...
<details>
	<summary>Answer</summary>
	<li>1: Configure a web proxy server in your VPC and enforce URL-based ru les for outbound access Remove default routes.
</li></ul>
</details>
...
- [ ] Send an email using DKIM with SE.
...
<details>
	<summary>Answer</summary>
	<li>1: Send an email using DKIM with SE.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: 1. Detach EBS volumes, 2. Start EBS snapshot of volumes, 3. Re-attach EBS volumes.
</li></ul>
</details>
...
- [ ] You will need to delete the Read Replica and create a new one to rep lace it.
...
<details>
	<summary>Answer</summary>
	<li>1: You will need to delete the Read Replica and create a new one to rep lace it.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Some services support resource-level permissions only for some actions.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: (IAM) policies, Access Control Lists (ACLs), bucket policies, and query string authentication.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create a public interface on your AWS Direct Connect link. Redistribute BGP routes into your existing routing infrastructure; advertise specific routes for your network to AWS.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Same as the standard data transfer charge.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: VPC with a Public Subnet Only and Hardware VPN Access.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Create an IAM Role that allows write access to the DynamoDB table.
</li>	<li>2: Add an IAM Role to a running EC2 instance.
</li>	<li>5: Launch an EC2 Instance with the IAM Role included in the launch configuration.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Pay for the instances that you use by the hour, with no long-term commitments or up-front payments.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Costs are incurred regardless of whether the ElP is associated with a running instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Reduced Redundancy Storage.
</li></ul>
</details>
...
- [ ] No, you cannot change security groups after you launch an instance in EC2-Classic.
- [ ] Yes, you can only when you remove rules from a security group.
- [ ] Yes, you can only when you add rules to a security group.
<details>
	<summary>Answer</summary>
	<li>2: No, you cannot change security groups after you launch an instance in EC2-Classic.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Amazon S3, Amazon SNS, Amazon SQS, Amazon Glacier and Amazon EB
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Allow users to use actions that start with 'Describe' over all the EC2 resources.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Yes, it can have depending on the TL.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: AWS Simple Notification Service.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: You can purchase an AMIs from a third party or can create your own AMI.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: You can use Amazon Simple Queue Service (Amazon SQS) notifications to notify you when the job completes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Setting up a federation proxy or identity provider.
</li>	<li>2: Using AWS Security Token Service to generate temporary tokens.
</li>	<li>4: Configuring IAM role.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Implement third party volume encryption tools.
</li>	<li>3: Encrypt data inside your applications before storing it on EBS.
</li>	<li>4: Encrypt data using native data encryption drivers at the file system level.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Make sure you submit a separate job request for each device.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The checks may still be in progress on the volume.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Yes, existing users can have security credentials associated with their account.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: The user can add zones on the fly from the AWS console.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Coordinate synchronous and asynchronous tasks which are distributed and fault tolerant.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Use SAML (Security Assertion Markup Language) to enable single sign-on between AWS and LDAP.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: A custom IAM user policy limited to the Amazon S3 API in 'company-backup'.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Billing commences when Amazon EC2 initiates the boot sequence of an AMI instance and billing ends when the instance shuts down.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Implement message passing between EC2 instances within a batch by exchanging messages through SQS.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: To an S3 bucket with 2 objects of 1TB.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Yes, it's called Direct Connect.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: In server-side encryption, you manage encryption/decryption of your data, the encryption keys, and related tools.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use Storage Gateway and configure it to use Gateway Cached volumes.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Amazon EBS root device volumes are copied into Amazon RD
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Push web clicks by session to Amazon Kinesis and analyze behavior using Kinesis workers.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: An ARN (Amazon Resource Name) is created.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: AWS Directory Service, Amazon Workspaces, and AWS Identity and Access Management.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Assign multiple ELBS to an EC2 instance or group of EC2 instances running the common components of the web application, one ELB for each platform type Session stickiness and SSLtermination are done at the ELBs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: In Amazon VPC, an instance does NOT retain its private IP addresses when the instance is stopped.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: All the options listed here.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Ask their customers to use an S3 client instead of an FTP client. Create a single S3 bucket Create an IAM user for each customer Put the IAM Users in a Group that has an IAM policy that permits access to sub-directories within the bucket via use of the 'username' Policy variable.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: SQS helps to facilitate horizontal scaling of encoding tasks.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Set a target value and choose whether the alarm will trigger when the value is greater than (>), greater than or equal to (>=), less than (<), or less than or equal to (<=) that value.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Virtual servers in the Cloud.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Gateway-Virtual Tape Library with snapshots to Amazon Glacier.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: It supports an unlimited number of queues and unlimited number of messages per queue for each user but automatically deletes messages that have been in the queue for more than 4 days.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Allow no inbound traffic, Allow all outbound traffic and Allow instances associated with this security group to talk to each other.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: It can export from Amazon Glacier.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The remaining Read Replicas will still replicate from the older master DB Instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: EBS backed instance with on-demand instance pricing.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Create your RDS instance as part of your Elastic Beanstalk definition and alter its security group to allow access to it from hosts in your application subnets.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Amazon S3 allows you to store unlimited amounts of data.
</li>	<li>5: Objects are directly accessible via a URL.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create an IAM role for EC2 that allows list access to objects in the S3 bucket. Launch the instance with the role, and retrieve the role's credentials from the EC2 Instance metadata.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Subnet's traffic is routed to an internet gateway.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Yes, through the Amazon EC2 APIs.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Use an array of EBS volumes.
</li>	<li>5: Increase the size of the EC2 Instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Support allow rules and deny rules.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Create the IAM roles with cross account access.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Create an inbound NACL (Network Access control list) associated with the web tier subnet with deny rules to block the attacking IP addresses.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: Create an image of the instance, and use this image to launch a new instance with the desired Lam role assigned.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Depends on the type of connection.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Backups to Amazon S3 be performed through the database management system.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The load balancer must reside in a subnet that is connected to the internet using the internet gateway.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Create two AWS OpsWorks stacks create two AWS OpsWorks layers create one custom recipe.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Procure all the instances as reserved instances beforehand.
</li>	<li>5: private key.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: Enable Source/Destination Check on the NAT instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: It's more secure than normal upload.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Yes, using the AWS multi-factor token devices to authenticate users on the AWS platform.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Start twenty instances as members of appserver group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: Attaching an ENI to an instance when it is stopped.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Select Public, enter the IDs of those AWS accounts, and click Save.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>4: You can't add more than 100 rules to security groups for an Amazon EC2 instance.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: AWS Service Health Dashboard.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>2: A hosted zone is a collection of resource record sets hosted by Route 53.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Do not select the AZ; instead let AWS select the AZ.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: Removes one or more rules from a security group.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: The mobile application will submit its location to a web service endpoint utilizing Elastic Load Balancing and EC2 instances: DynamoDB will be used to store and retrieve relevant otters EC2 instances will communicate with mobile earners/device providers to push alerts back to mobile application.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>3: 'Table', a collection of Items; 'Items', with Keys and one or more Attribute; and 'Attribute', with Name and Value.
</li></ul>
</details>
...
<details>
	<summary>Answer</summary>
	<li>1: It is a group of EC2 instances within a single Availability Zone.
</li></ul>
</details>
